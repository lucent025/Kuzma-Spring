...
public class ProductController {
	...
	public ResponseEntity<Page<ProductDTO>> getFilter(@RequestBody ProductFilter filter ,@RequestParam int page, @RequestParam int limit) {
		Pageable pageable = PageRequest.of(page, limit);
		return new ResponseEntity<Page<ProductDTO>>(service.getProductByFilter(filter, pageable), HttpStatus.OK);
	}
}
